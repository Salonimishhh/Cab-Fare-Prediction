...
setwd("D:/001. Data sc/Project/Cab_Fare_Prediction")


#loading libraries
x = c("ggplot2", "corrgram", "DMwR", "caret", "randomForest", "e1071","geosphere", "DataCombine", "pROC", "doSNOW", "class", "readxl","ROSE","dplyr", "plyr", "reshape","xlsx",
